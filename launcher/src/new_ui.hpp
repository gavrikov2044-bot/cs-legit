...
namespace ui {
    ...
    void RenderHomeTab(const std::vector<std::string>& games) {
        ...
        ImGui::TextColored(theme::text_secondary, "🎮 Games");
    ...
    void RenderGamesTab() {
        ...
        ImGui::SetCursorPos(ImVec2(40, 20));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ImGui::TextColored(theme::text, "🎮 AVAILABLE GAMES");
        ImGui::PopFont();
    ...
    void RenderStatsTab() {
        ...
        ImGui::SetCursorPos(ImVec2(40, 20));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ImGui::TextColored(theme::text, "📊 YOUR STATS");
        ImGui::PopFont();
    ...
    void RenderSettingsTab() {
        ...
        ImGui::SetCursorPos(ImVec2(40, 20));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ImGui::TextColored(theme::text, "⚙️ SETTINGS");
        ImGui::PopFont();
        ...
        ImGui::Checkbox("Check for updates automatically", &autoUpdate);
        ...
        static int injectionMethod = 1;
        ImGui::RadioButton("Manual", &injectionMethod, 0);
        ImGui::SameLine();
        ImGui::RadioButton("Auto", &injectionMethod, 1);
        ImGui::SameLine();
        ImGui::RadioButton("Manual Mapping", &injectionMethod, 2);
        
        ImGui::Spacing();
        
        static float injectionDelay = 5.0f;
        ImGui::TextColored(theme::text_secondary, "Injection Delay:");
        ImGui::SliderFloat("##delay", &injectionDelay, 0.0f, 10.0f, "%.1f seconds");
        ...
        ImGui::SameLine();
        if (ImGui::Button("🔄 RESET", ImVec2(200, 40))) {
            // Reset settings
        }
    ...
    void RenderProfileTab(const char* username) {
        ...
        ImGui::SetCursorPos(ImVec2(40, 20));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ImGui::TextColored(theme::text, "👤 PROFILE");
        ImGui::PopFont();
    ...
    void RenderNewsTab() {
        ...
        ImGui::SetCursorPos(ImVec2(40, 20));
        ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[1]);
        ImGui::TextColored(theme::text, "📰 NEWS & UPDATES");
        ImGui::PopFont();
